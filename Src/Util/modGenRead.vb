...
Public Function bReadFileGenericSmart(sFieldDelimiter$, bHeader As Boolean, _
...
Public Function bReadFileGeneric(sFieldDelimiter$, bHeader As Boolean, _
    sPath$, lineDeleg As clsDelegLine, msgDeleg As clsDelegMsg,
    ByRef iNbLines%, ByRef iNbColumns%, _
    Optional bLineByLine As Boolean = False, _
    Optional bOnlyFirstLines As Boolean = False, _
    Optional bOnlyFirstSplitLines As Boolean = False, _
    Optional encod As Encoding = Nothing, _
    ...
    If sFieldDelimiter = sQuotesCommaQuotesDelimiter OrElse _
